...
class MoveRobot(Node):
    def __init__(self):
        ...
        self.pose_subscriber = self.create_subscription(Pose, 'other_robot_pose', self.pose_callback, 10)
        
        self.twist = Twist()
        self.other_robot_pose = Pose()

    def pose_callback(self, msg):
        self.other_robot_pose = msg  #update other robot's position
...
def main(args=None):
    ...
    try:
        move_robot.move_robot_forward(5)  
